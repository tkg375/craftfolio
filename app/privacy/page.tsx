      ...
      <div className="max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>
          {[
            ...
            { title: "6. Your Rights", body: "You may request deletion of your account and all associated data at any time by emailing support@craftfolio.co. We will process your request within 30 days." },
            ...
            { title: "10. Contact", body: "Questions about your data? Email us at support@craftfolio.co." },
          ].map(({ title, body }) => (
            <div key={title}>
