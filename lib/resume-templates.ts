...
export const RESUME_TEMPLATES: ResumeTemplate[] = [
  {
    ...
    tagline: "Timeless, trusted by recruiters everywhere",
    bestFor: "Finance · Law · Accounting · HR · Government",
    features: ["Conservative single-column layout", "All-caps bold section headers", "Clean serif-adjacent styling", "100% ATS safe"],
    accentHex: "#1e293b",
  ...
  },
  {
    ...
    features: ["Accent header bar", "Generous white space", "Strong name display", "100% ATS safe"],
    accentHex: "#DC2626",
    previewStyle: "modern",
  },
  {
    id: "executive",
    name: "Executive",
    tagline: "Authority and scope — built to impress at the top",
    bestFor: "C-Suite · VP · Director · Senior Leadership",
    features: ["Bold achievement focus", "Signature results highlighted", "Polished & commanding tone", "100% ATS safe"],
    accentHex: "#1D4ED8",
  ...
  },
  {
    id: "technical",
    name: "Technical",
    tagline: "Skills-first layout built for engineering roles",
    bestFor: "Software Engineers · Data Scientists · DevOps · IT",
    features: ["Core competencies at top", "Tech stack prominence", "Project section included", "100% ATS safe"],
    accentHex: "#059669",
  ...
  },
  {
    id: "entry",
    name: "Entry Level",
    tagline: "Education-forward for new grads & career changers",
    bestFor: "New Graduates · Career Changers · Internships",
    features: ["Education prominently placed", "Projects & internships featured", "Transferable skills emphasis", "100% ATS safe"],
    accentHex: "#7C3AED",
